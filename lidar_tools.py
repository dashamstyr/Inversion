...
def molprof(z,wave, T_0 = 1.0):
    ...
    beta_t = vector of molecular backscatter coefficients [1/m*sr]
    alpha_t = vector of molecular extinction coefficients [1/m]
    """
    import numpy as np
    ...
    beta_p = np.zeros_like(beta_R)
    alpha_p = np.zeros_like(alpha_R)
...
if __name__ == '__main__':
    ...
    p_slope0 = ptools.calc_slope(p_rangecor0)    
    p_slope1 = ptools.calc_slope(p_rangecor1)    
    prat_slope = ptools.calc_slope(prat)
